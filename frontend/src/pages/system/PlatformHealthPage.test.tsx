...
const snapshot = {
  ...
  readiness: {
    status: "UP",
    dependencies: { readinessState: "UP", mongo: "UP" },
  },
  ingestion: {
    receivedTotal: 100,
    acceptedTotal: 96,
    validationRejectedTotal: 2,
    backpressureRejectedTotal: 2,
    shutdownRejectedTotal: 0,
    queueDepth: 12,
    queueCapacity: 100,
    queueUtilizationPercent: 12,
    activeWorkers: 2,
    workerCapacity: 4,
    averageBatchSize: 8,
    maxBatchSize: 20,
  ...
  liveTail: {
    ...
    authorizationFailuresTotal: 2,
  },
  alerts: {
    evaluationsTotal: 20,
    triggeredTotal: 2,
    deliverySuccessTotal: 1,
    deliveryFailureTotal: 1,
    deliveryRetryTotal: 1,
  },
  runtime: {
    heapUsedBytes: 1024 * 1024 * 128,
    heapMaxBytes: 1024 * 1024 * 512,
    gcPauseCount: 4,
    liveThreads: 18,
