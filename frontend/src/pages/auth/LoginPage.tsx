    ...
    <main className="grid min-h-screen place-items-center bg-slate-950 px-5">
      <section className="w-full max-w-md rounded-2xl bg-white p-8 shadow-2xl">
        <div className="mb-7 flex items-center gap-3">
          <span className="grid h-11 w-11 place-items-center rounded-xl bg-sky-600 font-black text-white">
            LM
          </span>
          <div>
            <h1 className="text-xl font-bold text-slate-950">LogMonitor</h1>
        ...
        <form className="space-y-5" onSubmit={submit}>
          ...
          <button
            ...
            className="w-full rounded-lg bg-sky-600 px-4 py-2.5 font-semibold text-white hover:bg-sky-700 disabled:cursor-not-allowed disabled:opacity-60"
          >
