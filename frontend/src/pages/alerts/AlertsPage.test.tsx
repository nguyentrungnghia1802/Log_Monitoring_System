...
const occurrence = {
  id: "occ-1",
  ruleId: "rule-1",
  ruleName: "Queue failures",
  projectId: "project-1",
  triggeredAt: "2026-08-18T01:00:00Z",
  windowStart: "2026-08-18T00:59:00Z",
  windowEnd: "2026-08-18T01:00:00Z",
  observedValue: 12,
  threshold: 10,
  status: "ACKNOWLEDGED" as const,
  deliveryStatus: "FAILED" as const,
  attemptCount: 2,
  acknowledgedAt: "2026-08-18T01:05:00Z",
  acknowledgedBy: "operator@example.com",
  lastAttemptAt: "2026-08-18T01:06:00Z",
  lastError: "provider unavailable",
  deliveryAttempts: [
    {
      attemptNumber: 2,
      provider: "telegram",
      attemptedAt: "2026-08-18T01:06:00Z",
...
describe("AlertsPage", () => {
  it("shows why an occurrence triggered, acknowledgement, and delivery history", async () => {
    vi.mocked(fetchProjects).mockResolvedValue([
      {
        ...
        active: true,
        environments: [],
        retention: { defaultDays: 30, levelOverrides: {} },
        settings: {},
        services: [],
        recentIngestion: {
          eventsLast24Hours: 0,
    ...
    expect(
      screen.getByRole("region", { name: "Alert occurrence detail" }),
    ).toHaveTextContent("12 events reached threshold 10");
