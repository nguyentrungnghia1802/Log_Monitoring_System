...
export function AlertRulesPage() {
    ...
    const createMutation = useMutation({
        mutationFn: (newRule: Partial<AlertRule>) => createAlertRule(projectId, newRule),
        onSuccess: () => {
        ...
        <div className="p-6 max-w-7xl mx-auto space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-sm text-slate-400">Configure log thresholds and automated triggers</p>
                </div>
                <button
            ...
            {isLoading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {rules.map((rule) => (
                        <div key={rule.id} className="bg-slate-900 border border-slate-800 rounded-xl p-5 space-y-3">
                            <div className="flex justify-between items-start">
                                ...
                                <button
                                    ...
                                    className={`px-3 py-1 text-xs rounded-full font-medium transition ${rule.enabled
                            ...
                            <div className="text-xs text-slate-300 bg-slate-950 p-3 rounded-lg flex justify-between">
                                ...
                                <div>
                                    ...
                                    <span className="font-mono text-slate-300">{rule.cooldownSeconds}s</span>
                                </div>
                            </div>
            ...
            {showModal && (
                <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 z-50">
                    <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 max-w-md w-full space-y-4">
                        <h2 className="text-lg font-bold text-slate-100">Create New Alert Rule</h2>
