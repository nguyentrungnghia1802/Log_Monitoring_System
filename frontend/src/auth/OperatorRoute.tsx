...
export function OperatorRoute() {
  ...
  if (!ready) {
    return <main className="grid min-h-screen place-items-center text-sm text-slate-600">Restoring your session...</main>
  }
    ...
    return (
      <main className="mx-auto max-w-3xl px-6 py-16">
        <div className="rounded-2xl border border-amber-200 bg-amber-50 p-8 text-amber-900">
          ...
          <p className="mt-2 text-sm">Platform health is available only to organization administrators.</p>
        </div>
      </main>
    )
  }
