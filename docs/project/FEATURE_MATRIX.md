...
| LINE Smart Queue F3 — Node source integration and structured failure events | `LINE Smart Queue Assistant` main `cfe947ed68f27ee215b0b3738c1182951b08c65c`, `apps/api/src/modules/log-monitoring`, instrumented auth/queue/order/payment/LINE/email/scheduler/DB paths | target API 116 suites/709 tests, frontend 11 files/17 tests, lint/typecheck/build; staging smoke command documented | [~] |
